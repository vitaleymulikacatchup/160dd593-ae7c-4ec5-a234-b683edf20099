...
export const metadata: Metadata = {
  title: "SaaS Pro - Modern Workflow Automation Platform",
  description: "Streamline your business with SaaS Pro. Real-time collaboration, powerful automation, and enterprise security for teams of any size.",
  keywords: "SaaS, workflow automation, team collaboration, productivity, business software",
  metadataBase: new URL("https://saaspro.com"),
  alternates: {
    canonical: "https://saaspro.com"
  },
  openGraph: {
    title: "SaaS Pro - Workflow Automation Made Simple",
    description: "Transform your team's productivity with SaaS Pro's powerful platform",
    siteName: "SaaS Pro",
    type: "website"
  },
  twitter: {
    card: "summary_large_image",
    title: "SaaS Pro - Workflow Automation Platform",
    description: "Empower your team with seamless collaboration and intelligent automation"
  }
};
